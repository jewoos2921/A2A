...
class PushNotificationListener:
    def __init__(self, host, port, notification_receiver_auth: PushNotificationReceiverAuth):
        ...
        self.thread = threading.Thread(target=lambda loop: loop.run_forever(), args=(self.loop,))
    ...
    def start(self):
        try:
            ...
            print(f"Error starting push notification listener: {e}")
    ...
    async def handle_validation_check(self, request: Request):
        ...
        return Response(validation_token, status_code=200)
